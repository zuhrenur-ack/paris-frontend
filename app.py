...
# 🔥 ARAMA MOTORU GÜÇLENDİRİLDİ: Hem TR hem EN isimleri yakalayacak
HAZIR_ACIKLAMALAR = {
    ...
    "eiffel": "TR: 1889 yılında Dünya Fuarı için geçici olarak inşa edilen bu devasa demir kule, günümüzde Paris'in kalbi ve dünyanın en ikonik yapısıdır. Şehri kuş bakışı izlemek için en mükemmel noktadır.\n\nEN: Built in 1889 for the World's Fair, this giant iron tower is now the heart of Paris and the world's most iconic structure. It is the perfect spot to view the city from a bird's eye view.",
    ...
    "triomphe": "TR: Şanzelize Caddesi'nin başında gururla yükselen bu anıt, Fransız ordusunun zaferlerini taçlandırmak için inşa edilmiştir. Tepesine çıktığınızda Paris'in 12 büyük caddesinin birleşimini izleyebilirsiniz.\n\nEN: Rising proudly at the beginning of the Champs-Élysées Avenue, this monument was built to honor the victories of the French army. From its top, you can watch the intersection of Paris's 12 major avenues."
}
...
if places_data:
    for p in places_data:
        ...
        if linked_city_id == selected_city_id or selected_city == "Paris":
            ...
            # 🔥 FOTOĞRAF KÜÇÜK/BÜYÜK HARF KURTARICISI
            img_url = None
            img_field = attrs.get('Image') or attrs.get('image') or attrs.get('Resim') or attrs.get('resim')
